...
class ArrayFileTest extends TestCase
{
    ...
    {
        $filePath = __DIR__ . '/fixtures/array/sample-array-file.php';
    ...
    {
        $filePath = __DIR__ . '/fixtures/array/sample-array-file.php';
        $tmpFile = __DIR__ . '/fixtures/array/temp-array-file.php';
    ...
    {
        $filePath = __DIR__ . '/fixtures/array/env-config.php';
        $tmpFile = __DIR__ . '/fixtures/array/temp-array-file.php';
    ...
    public function testConfigInvalid()
    {
        ...
        $arrayFile = ArrayFile::open(__DIR__ . '/fixtures/array/invalid.php');
    }

    public function testConfigImports()
    {
        $arrayFile = ArrayFile::open(__DIR__ . '/fixtures/array/import.php');
...
PHP;
    ...
    {
        $arrayFile = ArrayFile::open(__DIR__ . '/fixtures/array/expression.php');
...
PHP;
    ...
    {
        $file = __DIR__ . '/fixtures/array/missing.php';
...
PHP;
    ...
    {
        $file = __DIR__ . '/fixtures/array/include.php';
        $arrayFile = ArrayFile::open($file);
...
PHP;
    ...
    {
        $file = __DIR__ . '/fixtures/array/sample-array-file.php';
        $arrayFile = ArrayFile::open($file);
    ...
    {
        $file = __DIR__ . '/fixtures/array/nested-comments.php';
        $arrayFile = ArrayFile::open($file);
